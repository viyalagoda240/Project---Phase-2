...
<body>
    ...
    <div class="auth-container">
        <form id="signInForm">
            ...
            <a type="button" class="btn btn-primary w-100" href="index.php">Sign In</a>
        ...
        <form id="step1Form" class="d-none">
            ...
            <div class="row align-items-center">
                ...
                <div class="col">
                    <button type="button" class="btn btn-primary w-100" onclick="toggleFormReset('step2Form')">Send Confirmation Code</button>
                </div>
            </div>
        </form>
        ...
        <form id="step2Form" class="d-none">
            ...
            <form id="step2Form">
                ...
                <div class="row g-2 align-items-center">
                    <div class="col">
                        <button type="button" class="btn btn-primary w-100" onclick="toggleFormReset('step3Form')">Verify Code</button>
                    </div>
                </div>
            ...
            <form id="step3Form" class="d-none">
                ...
                <button type="button" class="btn btn-primary w-100">Reset Password</button>
